...
// our dialog text.
// X and Y padding are so that the text does not begin directly on the edge/corner of dialog box
// Line padding is the padding between lines of text
function dialog_create(box_width, box_height, x_padding, y_padding, line_padding, text)
{
	// Assumptions:
	...
	// GameMaker starts string indexing at 1
	var word_begin = 1;
	...
	/* Assuming that all characters in our string fall under these potential characters,
	we can get the heigh from the font.
	*/
